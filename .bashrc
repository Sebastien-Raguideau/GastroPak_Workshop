...
export PATH=~/repos/ont-guppy-cpu/bin:$PATH
 ...
 #------ STRONG path -------
export PATH=~/repos/STRONG/bin:$PATH 


 #------ guppy path -------
export PATH=~/repos/Bandage:$PATH


 #------ GastroPak_Workshop -------
export PATH=~/repos/GastroPak_Workshop/scripts:$PATH


 #------ strainberry -------
export PATH=/home/ubuntu/repos/strainberry:$PATH


 #------ plasmidnet -------
export PATH=/home/ubuntu/repos/PlasmidNet/bin:$PATH
